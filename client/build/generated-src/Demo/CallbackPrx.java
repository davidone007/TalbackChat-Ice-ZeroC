...
{
    default void reportResponse(String response)
    {
        reportResponse(response, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void reportResponse(String response, java.util.Map<String, String> context)
    {
        _iceI_reportResponseAsync(response, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> reportResponseAsync(String response)
    {
        return _iceI_reportResponseAsync(response, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> reportResponseAsync(String response, java.util.Map<String, String> context)
    {
        return _iceI_reportResponseAsync(response, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_reportResponseAsync(String iceP_response, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "reportResponse", null, sync, null);
