...
public interface PrinterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void message(CallbackPrx proxy, String msg)
    {
        message(proxy, msg, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void message(CallbackPrx proxy, String msg, java.util.Map<String, String> context)
    {
        _iceI_messageAsync(proxy, msg, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> messageAsync(CallbackPrx proxy, String msg)
    {
        return _iceI_messageAsync(proxy, msg, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> messageAsync(CallbackPrx proxy, String msg, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_messageAsync(CallbackPrx iceP_proxy, String iceP_msg, java.util.Map<String, String> context, boolean sync)
    {
